# Infos comparatives des joueurs
                    ...
                    try:
                        ...
                        # Footer avec infos
                        fig.text(0.99, 0.02, "🚀 Football Analytics Pro | Comparaison Elite Source: FBRef | Design: Performance Analytics",
    ...
    """, unsafe_allow_html=True)            with col_scatter1:
        ...
        with tab3:
            ...
            with col1:
                ...
                st.plotly_chart(fig_tech_radar, use_container_width=True)import streamlit as st
import pandas as pd
