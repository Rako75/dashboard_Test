with col2:
            ...
            progression_metrics = {
                ...
                'Centres/90': player_data.get('Centres tentés', 0) / (player_data['Minutes jouées'] / 90),
            ...
            for metric, value in progression_metrics.items():
                try:
                    if metric == 'Courses prog./90':
                        ...
                        distribution = df_filtered.get('Centres tentés', pd.Series([0]*len(df_filtered))) / (df_filtered['Minutes jouées'] / 90)
